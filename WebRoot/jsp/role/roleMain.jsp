...
<script type="text/javascript">
	...
	function delData() {
		...
		//alert(ids);
		if (confirm("确定删除吗?")) {
			location.href="${CONTEXT_PATH}/role/delete?ids="+ids;
		}
			...
			<div class="container-fluid">
				<div class="row-fluid">
					...
					<div class="btn-toolbar">
						<a href="${CONTEXT_PATH}/role/roleUI" class="btn btn-primary"> <img
                              ...
                              <font color="red">查无数据</font>
								...
								<c:forEach items="${page.list }" var="vo" varStatus="vs">
									<tr id="${vo.id}">
										...
										<td>${vo.name}</td>										
										<td><a href="${CONTEXT_PATH}/role/roleUI?id=${vo.id}" class="tick-circle">编辑</a></td>										
									</tr>
								</c:forEach>
									...
									<td colspan="8" style="padding: 0;">
										<div class="block-foot">
											<ul class="pagination pagination_ml pull-right">
												...
												<c:set var="actionUrl" value="${CONTEXT_PATH}/role/" />
